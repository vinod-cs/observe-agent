...
func OpenLogDisk(string, Scope, int64, int) (*LogDisk, error) {
	return nil, errors.New("Linux logs are unsupported on this platform")
}
func (*LogDisk) PutAdmission(context.Context, string, []byte) (Receipt, bool, error) {
	return "", false, errors.New("Linux logs are unsupported on this platform")
}
...
func (*LogDisk) Next(context.Context) (Item, error) {
	return Item{}, errors.New("Linux logs are unsupported on this platform")
}
